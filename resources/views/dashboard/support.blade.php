  ...
  <div class="col-lg-3 col-md-4 col-12 mb-md-0 mb-3">
    <div class="d-flex justify-content-between flex-column mb-2 mb-md-0">
      ...
      <div class="d-none d-md-block">
        <div class="mt-5">
          <img src="../../demo/assets/img/illustrations/sitting-girl-with-laptop-light.png" class="img-fluid w-px-200" alt="FAQ Image" data-app-light-img="illustrations/sitting-girl-with-laptop-light.png" data-app-dark-img="illustrations/sitting-girl-with-laptop-dark.html">
        </div>
      </div>
    </div>
  </div>
...
<div class="row text-center justify-content-center gap-sm-0 gap-3">
  <div class="col-sm-6">
    <div class=" py-3 rounded bg-faq-section text-center">
      ...
      <h4 class="mb-2"><a class="h4" href="tel:+(810)25482568">+ (254) 798 343 427</a></h4>
  ...
  <div class="col-sm-6">
    <div class=" py-3 rounded bg-faq-section text-center">
      ...
      <h4 class="mb-2"><a class="h4" href="mailto:help@help.com">help@skyliqsolutions.com</a></h4>
